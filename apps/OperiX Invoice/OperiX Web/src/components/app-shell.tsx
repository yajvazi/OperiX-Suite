...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const [expandedMenus, setExpandedMenus] = useState<Record<string, boolean>>({ invoices:true, payments:true, customers:true, reports:true });
