...
import { getPalette, normalizeBrandColor } from '../../theme/brand';
            ...
            <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
                        ...
                        <View style={styles.rowBetween}>
                            <View>
                                ...
                                <Text style={[styles.hint, { color: mutedColor }]}>
                                    Role: <Text style={{ fontWeight: '600', color: primaryColor }}>{profile.role?.toUpperCase() || 'OWNER'}</Text>
                                </Text>
                            </View>
                            <View style={[styles.badge, { backgroundColor: primaryColor + '20' }]}>
                                <Text style={{ color: primaryColor, fontSize: 10, fontWeight: '600' }}>ACTIVE</Text>
                            </View>
                        </View>
                ...
                <View style={styles.footer}>
                    <Button
                        ...
                        style={{ width: '100%' }}
                    />
                    <Text style={[styles.version, { color: mutedColor }]}>OperiX Invoice v2.0.0</Text>
                </View>
            </ScrollView>
            <SignaturePadModal
            ...
            {value ? (
                ...
                onDraw ? (
                    <View style={[styles.assetPreview, { flexDirection: 'row', gap: 10, padding: 10 }]}>
                        <TouchableOpacity style={[styles.uploadPlaceholder, { backgroundColor: isDark ? '#263A55' : '#F4F7FB', borderRadius: 8 }]} onPress={onDraw}>
                            <PenTool color={mutedColor} size={20} />
                            <Text style={{ color: mutedColor, fontSize: 11, marginTop: 4 }}>Draw</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.uploadPlaceholder, { backgroundColor: isDark ? '#263A55' : '#F4F7FB', borderRadius: 8 }]} onPress={onPick}>
...
const styles = StyleSheet.create({
    ...
    userAvatar: { width: 60, height: 60, borderRadius: 30, backgroundColor: '#004FFE', alignItems: 'center', justifyContent: 'center' },
    ...
    assetPreview: { height: 80, borderRadius: 12, borderStyle: 'dashed', borderWidth: 2, borderColor: '#263A55', overflow: 'hidden' },
