...
const dashboardActions: ActionItem[] = [
    { key: 'expensesDashboard', labelKey: 'expensesDashboard', icon: PieChart, color: '#004FFE', action: 'dashboard' },
    { key: 'expenseReports', labelKey: 'expenseReports', icon: BarChart3, color: '#3388FF', action: 'reports' },
];
        ...
        <View style={[styles.container, { backgroundColor: bgColor }]}>
            ...
            >
                ...
                <View style={styles.statsGrid}>
                    ...
                    <Card style={[styles.statCard, { borderTopColor: '#12B76A', borderTopWidth: 4 }]}>
                        <View style={styles.statHeader}>
                            <TrendingUp color="#12B76A" size={20} />
                            <Text style={[styles.statLabel, { color: mutedColor }]}>{t('totalIncomes', language)}</Text>
                        </View>
                        <Text style={[styles.statValue, { color: '#12B76A' }]}>
                ...
                {/* Balance Card */}
                <Card style={[styles.balanceCard, { backgroundColor: stats.balance >= 0 ? '#12B76A15' : '#ef444415' }]}>
                    <View style={styles.balanceContent}>
                        <View>
                            <Text style={[styles.balanceLabel, { color: mutedColor }]}>{t('balance', language)}</Text>
                            <Text style={[styles.balanceValue, { color: stats.balance >= 0 ? '#12B76A' : '#ef4444' }]}>
                                {formatCurrency(stats.balance)}
                            </Text>
                        </View>
                        <View style={[styles.balanceIcon, { backgroundColor: stats.balance >= 0 ? '#12B76A' : '#ef4444' }]}>
                            {stats.balance >= 0 ?
                ...
                <View style={styles.sectionHeader}>
                    <View style={styles.sectionTitleRow}>
                        <BarChart3 color="#004FFE" size={20} />
                ...
                <View style={styles.sectionHeader}>
                    <View style={styles.sectionTitleRow}>
                        <ArrowDownCircle color="#12B76A" size={20} />
