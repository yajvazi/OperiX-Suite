...
export function FaturatScreen({ navigation }: any) {
    ...
    const tabs: { key: TabType; labelKey: string; icon: any; color: string }[] = [
        { key: 'finances', labelKey: 'finances', icon: Wallet, color: '#004FFE' },
        ...
        return (
            ...
            >
                <View style={[styles.actionCard, { backgroundColor: cardBg }]}>
                    ...
                    {count > 0 && (
                        <View style={[styles.badge, { backgroundColor: 'rgba(0, 79, 254, 0.1)' }]}>
                            <Text style={[styles.badgeText, { color: '#004FFE' }]}>{count}</Text>
                        </View>
                    )}
        ...
        <>
            ...
            <View style={styles.quickActionsSection}>
                <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.quickActionsContainer}>
                    ...
                    >
                        <View style={[styles.quickActionIcon, { backgroundColor: '#12B76A15' }]}>
                            <Plus color="#12B76A" size={18} />
                        </View>
